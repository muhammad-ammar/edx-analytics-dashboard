...
To execute this script run the following command from the parent directory of course_validation:

    $ python -m course_validation.generate_report
"""
...
from course_validation import API_SERVER_URL, API_AUTH_TOKEN, DASHBOARD_SERVER_URL
from course_validation.course_reporter import CourseReporter, API_REPORT_KEYS, COURSE_PAGES
...
if __name__ == "__main__":
    ...
    client = Client(base_url=API_SERVER_URL, auth_token=API_AUTH_TOKEN, timeout=1000)
    reports = []
    ...
    for course_id in COURSES:
        ...
        reporter = CourseReporter(course, http_client)
